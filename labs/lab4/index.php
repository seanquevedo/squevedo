<?php
 ...
 //print_r($_GET); //displaying all content submitted in the form using the GET method
  ...
  if (isset($_GET['keyword'])) { //if form was submitted
      ...
      if(isset($_GET['layout'])) {   //checks whether parameter is apart of the URL or not. user checked a layout(horiz/vert)
          $orientation = $_GET['layout'];
      }
      
      if(!empty($_GET['category'])) {//checks whether there is a value for one front element. user selects a category
